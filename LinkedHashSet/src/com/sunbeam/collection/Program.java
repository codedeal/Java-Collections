...
public class Program
{
	...
	public static void addEmployee( Set<Employee> empList, Employee[] arr )
	{
	...
	public static Employee findEmployee( Set<Employee> empList, int empid )
	{
	...
	public static boolean removeEmployee( Set<Employee> empList, int empid )
	{				
	...
	public static void printEmployee( Set<Employee> empList)
	{
		for (Employee emp : empList)
			System.out.println(emp.toString());
	}
